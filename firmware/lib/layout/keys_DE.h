...
KEYS__SHIFTED(    quote,          KEYBOARD__2_At                       );
KEYS__SHIFTED(    secsign,        KEYBOARD__3_Pound                    );
...
// ---
KEYS__DEFAULT(    lessThan,       KEYBOARD__Backslash_Pipe             );
KEYS__DEFAULT(    udiaresis,      KEYBOARD__LeftBracket_LeftBrace      );
...
KEYS__DEFAULT(    grave,          KEYBOARD__Equal_Plus                 );
KEYS__DEFAULT(    caret,          KEYBOARD__GraveAccent_Tilde          );
KEYS__DEFAULT(    period,         KEYBOARD__Period_GreaterThan         );
KEYS__DEFAULT(    adiarsis,       KEYBOARD__SingleQuote_DoubleQuote    );
KEYS__DEFAULT(    odirasis,       KEYBOARD__Semicolon_Colon            );
KEYS__DEFAULT(    dash,           KEYBOARD__Slash_Question             );
// --- (shifted) ---
KEYS__SHIFTED(    grtrThan,       KEYBOARD__Backslash_Pipe             );
KEYS__SHIFTED(    Udiaresis,      KEYBOARD__LeftBracket_LeftBrace      );
...
KEYS__SHIFTED(    acute,           KEYBOARD__Equal_Plus                 );
KEYS__SHIFTED(    degree,         KEYBOARD__GraveAccent_Tilde          );
KEYS__SHIFTED(    colon,          KEYBOARD__Period_GreaterThan         );
KEYS__SHIFTED(    Adiaresis,      KEYBOARD__SingleQuote_DoubleQuote    );
KEYS__SHIFTED(    Odiaresis,      KEYBOARD__Semicolon_Colon            );
