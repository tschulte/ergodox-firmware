...
KB_MATRIX_LAYER(
	...
	_guiL,		_Q,         _W,      _E,      _R,    _T,		_tab,	
	_tab,		_A,         _S,      _D,      _F,    _G,	
	_shiftL,	_Z,         _X,      _C,      _V,    _B,		_del,	
	_cut,		_copy,		_paste,		_find,		_altR,
									2,		_select,	_altL,
									0,		0,			
									_enter,		 _capsLock,	_ctrlL,
	// right hand
	0,		_6,		_7,		_8,		_9,		_0,	_bs,	
	_home,		_Y,      _U,      _I,      _O,         _P,	_sub_kp,	
			_H,      _J,      _K,      _L, _semicolon,    _quote,	
	_end,		_N,      _M,  _comma, _period,     _slash,   _shiftR,	
	_altR,		_application,	_print,		_pageD,		_pageU,	
									0,		0,	
									_ctrlR,		0,		0,	
									_bs,		_backslash,	_space	
),
// LAYER 1
KB_MATRIX_LAYER(
	// unused
